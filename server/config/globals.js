...
module.exports.globals = {
  ...
  ****************************************************************************/
  ...
  /**
   * We declared the `transporter` on Sails' as global variable for `nodemailer` to use.
   * To use the `transporter` variable through-out the app:
   * ```
   *    sails.config.globals.transporter = nodemailer.....
   * ```
   */
  transporter: ''
};
